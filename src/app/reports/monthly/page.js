        ...
        <>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '12px' }}>
            ...
            <div style={{ display: 'flex', gap: '8px' }}>
              <button onClick={expandAll} style={{ padding: '8px 18px', borderRadius: '10px', border: '1px solid var(--border)', backgroundColor: 'var(--bg-card)', color: 'var(--text-secondary)', fontWeight: '600', fontSize: '13px', cursor: 'pointer' }}>
                Expand All
              </button>
              <button onClick={collapseAll} style={{ padding: '8px 18px', borderRadius: '10px', border: '1px solid var(--border)', backgroundColor: 'var(--bg-card)', color: 'var(--text-secondary)', fontWeight: '600', fontSize: '13px', cursor: 'pointer' }}>
                Collapse All
              </button>
            </div>
          </div>
          ...
          {Object.keys(data.months).length === 0 ? (
            <div style={{ ...card, padding: '80px 24px', textAlign: 'center', color: 'var(--text-muted)', fontWeight: '600' }}>
                ...
                <div key={key} style={{ ...card, overflow: 'hidden' }}>
                  ...
                  >
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '24px', flexShrink: 0 }}>
                      ...
                      <svg
                        width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--text-secondary)" strokeWidth="2.5"
