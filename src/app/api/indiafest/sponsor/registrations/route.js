...
// ── GET: list all grand sponsor registrations ──────────────────────────────────
export async function GET(request) {
  ...
  try {
    ...
    console.error('[SponsorRegistrations GET] Error:', err.message);
    return NextResponse.json({ success: false, error: err.message }, { status: 500 });
  }
}

// ── PUT: update a sponsor registration ────────────────────────────────────────
export async function PUT(request) {
  ...
  try {
    ...
    console.error('[SponsorRegistrations PUT] Error:', err.message);
    return NextResponse.json({ success: false, error: err.message }, { status: 500 });
  }
}

// ── DELETE: delete a sponsor registration ─────────────────────────────────────
export async function DELETE(request) {
  ...
  try {
    ...
    const res = await fetch(
      `${SUPABASE_URL}/rest/v1/vendor_registrations?id=eq.${id}&space_type=eq.grand_sponsor`,
      {
        method: 'DELETE',
        headers: {
          'apikey':        KEY,
    ...
    console.error('[SponsorRegistrations DELETE] Error:', err.message);
    return NextResponse.json({ success: false, error: err.message }, { status: 500 });
  }
}
